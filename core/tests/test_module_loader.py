...
class TestModuleLoader:
    ...
    def test_load_modules_import_error(
        self, mock_import, state_manager, temp_modules_dir
    ):
    ...
    @patch("app.module_loader.importlib.import_module")
    def test_load_modules_no_tool_class(
        self, mock_import, state_manager, temp_modules_dir
    ):
    ...
    @patch("app.module_loader.importlib.import_module")
    def test_load_modules_successful_loading(
        self, mock_import, state_manager, temp_modules_dir
    ):
    ...
    @patch("app.module_loader.importlib.import_module")
    def test_load_modules_instantiation_error(
        self, mock_import, state_manager, temp_modules_dir
    ):
        ...
        with patch("app.module_loader.inspect.getmembers") as mock_getmembers:
            mock_getmembers.return_value = [("FailingTool", FailingTool)]
