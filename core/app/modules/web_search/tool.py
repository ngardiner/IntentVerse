...
class WebSearchTool(BaseTool):
    ...
    def __init__(self, state_manager: Any):
        ...
        if 'web_search' not in self.state_manager.get_full_state():
            self.state_manager.set('web_search', {
                "search_history": [],
                "last_search_results": []
            })
        ...
        self.search_topics = {
            ...
            "ai": [
                {"title": "What is Artificial Intelligence (AI)?", "url": "https://www.ibm.com/cloud/learn/what-is-artificial-intelligence", 
                ...
                {"title": "Machine Learning - Stanford University", "url": "https://www.coursera.org/learn/machine-learning", 
            ...
            "news": [
                ...
                {"title": "CNN - Breaking News, Latest News and Videos", "url": "https://www.cnn.com/", 
                 "snippet": "View the latest news and breaking news today for U.S., world, weather, entertainment, politics and health."},
                {"title": "Reuters - Breaking International News & Views", "url": "https://www.reuters.com/", 
    ...
    def _generate_search_results(self, query: str) -> List[Dict[str, str]]:
        ...
        if any(term in query_lower for term in ["python", "javascript", "code", "programming", "developer", "software"]):
            results = self._customize_results(self.search_topics["programming"], query)
        elif any(term in query_lower for term in ["ai", "artificial intelligence", "machine learning", "neural", "model"]):
            results = self._customize_results(self.search_topics["ai"], query)
        elif any(term in query_lower for term in ["news", "current events", "today", "latest"]):
    ...
    def _customize_results(self, base_results: List[Dict[str, str]], query: str) -> List[Dict[str, str]]:
        """
        ...
        for result in base_results:
            ...
            if random.random() > 0.5:
                custom_result["snippet"] = f"{result['snippet']} Learn more about {query} here."
