...
class ModuleLoader:
    ...
    def _get_module_description(self, module_name: str) -> str:
        ...
        try:
            if module_name in self.modules:
                return self.modules[module_name].__class__.__doc__ or f"Tool module for {module_name}"
            elif module_name in self.disabled_modules:
                return self.disabled_modules[module_name].__class__.__doc__ or f"Tool module for {module_name}"
            else:
    ...
    def set_module_enabled(self, module_name: str, enabled: bool, session: Session) -> bool:
