...
class TestMCPMessage:
    ...
    def test_create_request_message(self):
        ...
        message = MCPMessage(id=1, method="tools/list", params={"filter": "test"})
    ...
    def test_create_response_message(self):
        ...
        message = MCPMessage(id=1, result={"tools": []})
    ...
    def test_create_notification_message(self):
        ...
        message = MCPMessage(method="notifications/initialized")
    ...
    def test_to_dict(self):
        ...
        message = MCPMessage(id=1, method="test", params={"key": "value"})
        ...
        return {
            ...
            "inputSchema": {
                ...
                "properties": {
                    ...
                    "max_size": {"type": "integer", "description": "Maximum file size"},
                },
                "required": ["path"],
            },
        }
...
class TestHTTPTransport:
    ...
    async def test_is_healthy(self, http_config):
        ...
        # Mock health check
        respx.head("http://localhost:3000/mcp").mock(return_value=httpx.Response(200))
    ...
    async def test_call_tool_success(self, stdio_config):
        ...
        with patch.object(client, "send_request") as mock_request:
            ...
            mock_request.assert_called_once_with(
                "tools/call", {"name": "test_tool", "arguments": {"param": "value"}}
            )
