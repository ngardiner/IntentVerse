...
class TestParameterValidator:
    ...
    def test_validate_string_parameter(self):
        ...
        # Valid string
        result = validator.validate_parameter("test_string", "string", {"type": "string"})
    ...
    def test_validate_boolean_parameter(self):
        ...
        # Valid booleans
        assert validator.validate_parameter(True, "boolean", {"type": "boolean"}) is True
        assert validator.validate_parameter(False, "boolean", {"type": "boolean"}) is False
...
class TestProxyToolGenerator:
        ...
        return ToolInfo(
            ...
            schema={
                ...
                "properties": {
                    ...
                    "count": {"type": "integer", "minimum": 1, "description": "Number of times to process"}
                },
                "required": ["message"]
            },
    ...
    def test_get_generation_stats(self, generator):
        ...
        tool1 = ToolInfo(
            name="tool1", description="Tool 1", server_name="server1",
            original_name="tool1", schema={"type": "object"}, metadata={}
        )
        tool2 = ToolInfo(
            name="tool2", description="Tool 2", server_name="server1",
            original_name="tool2", schema={"type": "object"}, metadata={}
        )
        tool3 = ToolInfo(
            name="tool3", description="Tool 3", server_name="server2",
            original_name="tool3", schema={"type": "object"}, metadata={}
        )
